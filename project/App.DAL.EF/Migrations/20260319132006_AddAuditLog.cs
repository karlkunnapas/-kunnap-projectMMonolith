        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactEmail = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ContactPhone = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangesJson = table.Column<string>(type: "character varying(16000)", maxLength: 16000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChargingStations_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleConnectors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleConnectors_Connectors_ConnectorId",
                        column: x => x.ConnectorId,
                        principalTable: "Connectors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VehicleConnectors_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Maintenances_AspNetUsers_AssignedToUserId",
                        column: x => x.AssignedToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Maintenances_AspNetUsers_ReportedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Maintenances_AssignedToUserId",
                table: "Maintenances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ChargingStationId",
                table: "Reservations",
                column: "ChargingStationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleConnectors_ConnectorId",
                table: "VehicleConnectors",
                column: "ConnectorId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleConnectors_VehicleId",
                table: "VehicleConnectors",
                column: "VehicleId");
