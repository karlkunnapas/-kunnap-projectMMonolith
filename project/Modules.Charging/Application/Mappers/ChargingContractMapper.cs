...
{
    public static ChargingStationContract ToContract(ChargingStationDto dto)
    {
        return new()
        {
            Id = dto.Id,
    ...
    public static AdminChargingStationContract ToContract(AdminChargingStationDto dto)
    {
        return new()
        {
    ...
    public static ConnectorContract ToContract(ConnectorDto dto)
    {
        return new()
        {
            Id = dto.Id,
    ...
    public static ConnectorTypeContract ToContract(ConnectorTypeDto dto)
    {
        return new()
        {
    ...
    public static ReservationContract ToContract(ReservationDto dto)
    {
        return new()
        {
            Id = dto.Id,
    ...
    public static ChargingSessionContract ToContract(ChargingSessionDto dto)
    {
        return new()
        {
            Id = dto.Id,
    ...
    public static MaintenanceContract ToContract(MaintenanceDto dto)
    {
        return new()
        {
            Id = dto.Id,
    ...
    public static CompanyDashboardStatsContract ToContract(CompanyDashboardStatsDto dto)
    {
        return new()
        {
    ...
    public static UpsertCompanyStationDto ToDto(UpsertCompanyStationContract contract)
    {
        return new()
        {
    ...
    public static ReservationDto ToDto(ReservationContract contract)
    {
        return new()
        {
            Id = contract.Id,
    ...
    public static ChargingSessionDto ToDto(ChargingSessionContract contract)
    {
        return new()
        {
            Id = contract.Id,
    ...
    public static MaintenanceDto ToDto(MaintenanceContract contract)
    {
        return new()
        {
            Id = contract.Id,
